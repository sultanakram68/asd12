...
export function MainLayout() {
  ...
  return (
    <div className="min-h-screen bg-bg-base text-white relative overflow-hidden flex flex-col">
      ...
      {/* Floating Header with Top Fade Mask */}
      <header className="fixed top-0 left-0 right-0 z-50 px-6 pt-4 pb-8 lg:px-12 flex justify-center pointer-events-none bg-gradient-to-b from-bg-bg-base via-bg-bg-base to-transparent/0">
        <motion.div 
